// Generated by Bisonc++ V6.04.03 on Thu, 10 Jun 2021 11:19:46 +0200
...
template <>
struct TagOf<Opcode::Byte>
{
    static Tag_ const tag = Tag_::OPCODE;
};

template <>
struct TagOf<Tokens::Tokens_>
{
    static Tag_ const tag = Tag_::TOKEN;
};
...
struct TagOf<SemVal>
{
    static Tag_ const tag = Tag_::SEMVAL;
};
...
template <>
struct TypeOf<Tag_::OPCODE>
{
    typedef Opcode::Byte type;
};

template <>
struct TypeOf<Tag_::TOKEN>
{
    typedef Tokens::Tokens_ type;
};

template <>
struct TypeOf<Tag_::ARGS>
{
    typedef Args type;
};

template <>
struct TypeOf<Tag_::SEMVAL>
{
    typedef SemVal type;
};
...
// $insert polymorphicOpAssignDecl
        SType &operator=(Opcode::Byte const &value);
        SType &operator=(Opcode::Byte &&tmp);

        SType &operator=(Tokens::Tokens_ const &value);
        SType &operator=(Tokens::Tokens_ &&tmp);

        SType &operator=(Args const &value);
        SType &operator=(Args &&tmp);

        SType &operator=(SemVal const &value);
        SType &operator=(SemVal &&tmp);
...
inline SType &SType::operator=(Opcode::Byte const &value)
{
    assign< Tag_::OPCODE >(value);
    return *this;
}
inline SType &SType::operator=(Opcode::Byte &&tmp)
{
    assign< Tag_::OPCODE >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(Tokens::Tokens_ const &value)
{
    assign< Tag_::TOKEN >(value);
    return *this;
}
inline SType &SType::operator=(Tokens::Tokens_ &&tmp)
{
    assign< Tag_::TOKEN >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(Args const &value)
{
    assign< Tag_::ARGS >(value);
    return *this;
}
inline SType &SType::operator=(Args &&tmp)
{
    assign< Tag_::ARGS >(std::move(tmp));
    return *this;
}
inline SType &SType::operator=(SemVal const &value)
{
    assign< Tag_::SEMVAL >(value);
    return *this;
}
inline SType &SType::operator=(SemVal &&tmp)
{
    assign< Tag_::SEMVAL >(std::move(tmp));
    return *this;
}
